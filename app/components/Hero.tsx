...
import { CALENDLY_LINK, WHATSAPP_LINK } from "@/constants/app.contantants";
      ...
      <div className="container relative mx-auto w-full max-w-6xl px-6 z-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary w-full sm:w-auto justify-center">
              <Image src="/whatsapp.svg" alt="WhatsApp" width={20} height={20} />
              {t('chatWhatsApp')}
            </a>

            <a href={CALENDLY_LINK} target="_blank" rel="noopener noreferrer" className="btn-secondary w-full sm:w-auto justify-center">
              {t('bookCall')}
