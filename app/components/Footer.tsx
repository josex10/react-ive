      ...
      <div className="container mx-auto max-w-[1200px] px-6">
        ...
        <div className="mb-20 flex flex-wrap justify-between gap-15">
          ...
          <div className="flex flex-wrap gap-15">
            <div className="flex flex-col gap-4">
              <div className="mb-2 text-[15px] font-semibold text-[#F4F7F6]">Platform</div>
            ...
            <div className="flex flex-col gap-4">
              <div className="mb-2 text-[15px] font-semibold text-[#F4F7F6]">Company</div>
              <a href="#" className="text-sm text-[#F4F7F6]/60 no-underline transition-colors duration-200 hover:text-[#00D2FF]">About Us</a>
              <a href="#" className="text-sm text-[#F4F7F6]/60 no-underline transition-colors duration-200 hover:text-[#00D2FF]">Case Studies</a>
              <a href="#" className="text-sm text-[#F4F7F6]/60 no-underline transition-colors duration-200 hover:text-[#00D2FF]">Contact</a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-5 border-t border-white/5 pt-8">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-[13px] text-[#F4F7F6]/40 no-underline hover:text-white/60">Privacy Policy</a>
            <a href="#" className="text-[13px] text-[#F4F7F6]/40 no-underline hover:text-white/60">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
